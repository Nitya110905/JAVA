...
public class Q002_Ascending_Descending {
...
//              ASCENDING AS PER DEPARTMENT NO.S
	            
	            
//	            String sql = "SELECT * FROM employee ORDER BY dept_no ASC";
//	            ResultSet rs = stmt.executeQuery(sql);
	            
//	            DESCENDING AS PER JOBS
	            String sql = "SELECT * FROM employee ORDER BY job DESC";
	            ResultSet rs = stmt.executeQuery(sql);
	            while (rs.next()) {
