	  ...
	  private static final String URL = "jdbc:mysql://localhost:3306/assignment";
	    ...
	    public static void main(String[] args) {
	        ...
	        try {
	            ...
	            String sql = "SELECT * FROM employee where salary IN (SELECT DISTINCT salary from employee where e_name IN ('Ford','Smith')) ORDER BY salary DESC ";
